...
contract and grants no state, terminal, document, persistence, provider, or
...
not packaged runtime input. The frozen host-owned importer handles migration;
the package exposes no migration service or generic effect contract.
